...
exports.StockInComponent = void 0;
var core_1 = require("@angular/core");
var forms_1 = require("@angular/forms");
var rxjs_1 = require("rxjs");
var stock_in_model_1 = require("src/app/models/stock-in.model");
var StockInComponent = /** @class */ (function () {
    function StockInComponent(stockInService, ngxSpinnerService, productService, stockUnitService, route, fb, confirmDialog, authService, pMessageService) {
        ...
        this.data$ = this.stockInService.dataObs$;
        this.modalDisplay = false;
        this.modalEditDisplay = false;
        this.imagePath = 'assets/images/crud/ready-stock.png';
    }
    Object.defineProperty(StockInComponent.prototype, "amount", {
        get: function () {
    ...
    Object.defineProperty(StockInComponent.prototype, "price", {
        get: function () {
    ...
    Object.defineProperty(StockInComponent.prototype, "stockUnit", {
        get: function () {
    ...
    Object.defineProperty(StockInComponent.prototype, "product", {
        get: function () {
    ...
    StockInComponent.prototype.ngOnInit = function () {
        ...
        this.col = stock_in_model_1.stockInCol;
        ...
        this.stockInService.findAll(this.brchId).pipe(rxjs_1.takeUntil(this.destroy$)).subscribe({
            next: function (data) {
                _this.data = data;
                _this.stockInService.dataSub$.next(data);
            },
            error: function () {
    ...
    StockInComponent.prototype.dpEditEvent = function (obj) {
        var _this = this;
    ...
    StockInComponent.prototype.dpRemoveEvent = function (_a) {
        var _this = this;
        var id = _a.id;
        var currentData;
        this.data.map(function (data) {
        ...
        this.confirmDialog.confirm({
            ...
            accept: function () {
                ...
                _this.stockInService["delete"](deleteDto).subscribe({
                    complete: function () {
                        _this.ngxSpinnerService.show();
                        _this.pMessageService.deleteSuccess();
                        _this.stockInService.findAll(_this.brchId).pipe(rxjs_1.takeUntil(_this.destroy$)).subscribe({
                            next: function (data) {
                                _this.data = data;
                                _this.stockInService.dataSub$.next(data);
                            },
    ...
    StockInComponent.prototype.onHide = function (e) {
        document.querySelector('body').style.overflowY = 'auto';
        this.modalDisplay = e;
        this.modalEditDisplay = e;
        this.form.reset();
    };
    StockInComponent.prototype.ngOnDestroy = function () {
        this.destroy$.next(true);
        this.destroy$.unsubscribe();
    };
    StockInComponent.prototype.create = function () {
        var _this = this;
        var _a, _b, _c, _d, _e, _f, _g, _h;
        (_a = this.amount) === null || _a === void 0 ? void 0 : _a.markAsDirty();
        (_b = this.price) === null || _b === void 0 ? void 0 : _b.markAsDirty();
        ...
        if (this.form.valid) {
            ...
            var createDto = {
                ...
                price: (_h = this.price) === null || _h === void 0 ? void 0 : _h.value
            };
    ...
    StockInComponent.prototype.update = function () {
        var _this = this;
        var _a, _b, _c, _d, _e, _f, _g, _h;
        (_a = this.amount) === null || _a === void 0 ? void 0 : _a.markAsDirty();
        (_b = this.price) === null || _b === void 0 ? void 0 : _b.markAsDirty();
...
exports.StockInComponent = StockInComponent;
